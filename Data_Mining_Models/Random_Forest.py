...
class Random_Forest:
    def __init__(self,df,instruction):
            ...
            self.root.title("Random Forest Regression")
            ...
            if instruction=='r':
                self.root.title("Random Forest Regression")
                self.plot_btn = ttk.Button(self.top_f, text = 'Create Random Forest Regression Model', command = self.reg)
                self.plot_btn.pack(side = LEFT, ipady = 5, ipadx = 5)
            else:
                self.root.title("Random Forest Classification")
                self.plot_btn = ttk.Button(self.top_f, text = 'Create Random Forest Classification Model', command = self.clas)
                self.plot_btn.pack(side = LEFT, ipady = 5, ipadx = 5)
    ...
    def reg(self):
        ...
        self.master = Tk()
        self.master.title("Random Forest Regresion")
        ...
        self.t = Label(self.master, font = ('times new roman', 10), text = "Give The Number of Trees.", bg = '#ffffff')
        self.t.grid(row = 0, column = 2, ipady = 5, ipadx = 5)

        self.option1 = ttk.Entry(self.master, textvariable = self.v1, width = 10)
        self.option1.grid(row = 0, column = 3, ipady = 5, ipadx = 5)
    ...
    def vizu(self):
        ...
        self.reg = RandomForestRegressor(n_estimators = int(self.v1.get()))
        ...
        self.ax.clear()
        self.ax.title.set_text("Random Forest Regression")
        ...
        self.ax.plot(X_grid, self.reg.predict(X_grid), label = 'Random Forest Regression Line')
    ...
    def clas(self):
        ...
        self.master = Tk()
        self.master.title("Random Forest Classification")
        self.master.configure(background = 'white')

        self.v = StringVar(self.master)
        self.v.set(self.names[0]) # default value

        self.kel = ['Gini', 'Entropy']
        ...
        self.v2.set(10) # default value

        Label(self.master, font = ('times new roman', 10), text = "Select Independent Value:", bg = '#ffffff').grid(row = 0, column = 0)
        ttk.OptionMenu(self.master, self.v, *self.names).grid(row = 0, column = 1, ipady = 5, ipadx = 5)

        Label(self.master, font = ('times new roman', 10), text = "Select Criterion:", bg = '#ffffff').grid(row = 0, column = 2)
        ttk.OptionMenu(self.master, self.v1, *self.kel).grid(row = 0, column = 3, ipady = 5, ipadx = 5)

        Label(self.master, font = ('times new roman', 10), text = "Give The Number of Trees.", bg = '#ffffff').grid(row = 1, column = 0, ipady = 5, ipadx = 5)
        ttk.Entry(self.master, textvariable = self.v2, width = 10).grid(row = 1, column = 2, ipady = 5, ipadx = 5)
    ...
    def vizu_clas(self):
        ...
        # Fitting the RFC
        self.clas = RandomForestClassifier(n_estimators = num_of_trees, criterion = kel)
    ...
    def predict(self):
        ...
        self.master1.title("Data Viewer")
        self.master1.geometry('800x500') 
        f = Frame(self.master1)
        ...
        self.c = ttk.Button(self.master1, text = 'Close', command = self.master1.destroy).pack()
